<%@ Page Title="" Language="C#" MasterPageFile="~/TrcnMaster.master" AutoEventWireup="true" CodeFile="UploadedPictureAndSignatureLogLicensed.aspx.cs" Inherits="StateOffice_UploadedPictureAndSignatureLogLicensed" ValidateRequest ="false"  %>
    ...
    <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Upload Teacher's Picture and Signature  </a>
                </li>
                <li class="breadcrumb-item active">Uploaded Teacher's Picture and Signature Log
                </li>
            </ol>
        </div>
    </div>
    <div class=" content-body">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><i class="fa fa-credit-card "></i>&nbsp Uploaded Picture and Signature Log</h4>
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li>
                            <div class="dropdown-menu arrow" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
                                ...
                                <asp:LinkButton ID="lnkExportToExcel" Visible="false" runat="server" OnClick="chkVerified" CssClass="dropdown-item"><i class=" la la-floppy-o"></i>&nbsp Print Checked Rows</asp:LinkButton>
                    ...
                    <div class="form-body">
                        ...
                        <div class=" table-responsive-sm" id="divContent" runat="server">
                            <asp:GridView ID="ABIA" runat="server" Font-Size="10px" AllowPaging="true" PageSize="20" OnPageIndexChanging="ABIACHANGING"
                                CssClass="table table-striped table-bordered dataex-res-configuration " AutoGenerateColumns="false" OnRowCommand="ABIACOMMAND"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="5%" HeaderText="Edit Signature" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="5%" HeaderText="Edit Picture" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="Center" HeaderText="Passport" FooterStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Image ID="imgphoto" runat="server" CssClass="avatar" Width="30px" Height="30px" ImageUrl='<%#Eval("Picture")%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="Center" HeaderText="Signature" FooterStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Image ID="imgphotoS" runat="server" CssClass=" avatar" Width="30px" Height="30px" ImageUrl='<%#Eval("Teacher Signature")%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:BoundField DataField="Registration_no" HeaderText="Registration_no" SortExpression="Registration_no" />

                                    <asp:BoundField DataField="Teacher's Name" HeaderText="Teacher's Name" SortExpression="Teacher's Name" />
