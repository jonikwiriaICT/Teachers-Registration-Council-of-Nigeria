...
public partial class StateOffice_UploadPictureAndSignatureLicensed : System.Web.UI.Page
{
        ...
        try
        {
            if (e.CommandName.Equals("upload"))
            {
                ...
                if (fileupload.HasFile)
                {
                    ...
                    fileupload.SaveAs(Server.MapPath("~/upload/") + sYearMonthDay + filename);
                    string URL = "~/upload/" + sYearMonthDay + filename;
                    sSignature.Value = URL;
                }
                else
                {
                    DisplayError("No Upload");
                }
                ...
                if (fileupload2.HasFile)
                {
                    ...
                    fileupload2.SaveAs(Server.MapPath("~/upload/") + sYearMonthDay + filename1);
                    string URL1 = "~/upload/" + sYearMonthDay + filename1;
                    sPicture.Value = URL1;
                }
                else
                {
