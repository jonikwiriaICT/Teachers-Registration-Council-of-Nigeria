<%@ Page Title="" Language="C#" MasterPageFile="~/TrcnMaster.master" AutoEventWireup="true" CodeFile="AttendedToComplainForm.aspx.cs" Inherits="HenryAdm_AttendedToComplainForm" ValidateRequest ="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Complain Form Attended To
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div id="TeacherForm" runat="server">
        ...
        <div class=" card">
            <div class="card-header">
                <h4 class="card-title"><i class=" la la-user "></i>&nbsp Complain Form  Attendd To </h4>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-h font-medium-3"></i></a>
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-7">
                                            ...
                                            <div class="form-group ic-cmp-int">
                                                ...
                                                <div class="nk-int-st">
                                                    <asp:LinkButton ID="lnkSave" runat="server" OnClick="saveChanges" CssClass="btn btn-sm btn-info pull-right white  "><i class="fa fa-floppy-o "></i>&nbsp Save Changes (Undo Changes)</asp:LinkButton>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
