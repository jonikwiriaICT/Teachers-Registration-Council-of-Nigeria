<%@ Page Title="" Language="C#" MasterPageFile="~/TrcnMaster.master" AutoEventWireup="true" CodeFile="CertificateNotPrinted.aspx.cs" Inherits="HenryAdm_CertificateNotPrinted" ValidateRequest ="false"  %>
     ...
     <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#"> Printed Certificate</a>
                </li>
                <li class="breadcrumb-item active">Not Printed Certificates
                </li>
            </ol>
        </div>
    </div>
    <div class=" content-body">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><i class=" la la-certificate "></i>&nbsp Not Printed Certificate</h4>
                ...
                <div class=" form-element-list " style="overflow: auto">
                    <div class="form-body">
                        ...
                        <div class=" table-responsive-sm" id="divContent" runat="server">
                            <asp:GridView ID="ABIA" runat="server" Font-Size="10px" AllowPaging="true" PageSize="200" OnPageIndexChanging="ABIACHANGING"
                        ...
                        <asp:DataList ID="dtPrint" Style="width: 100%; border: none" BorderColor="white" runat="server" EnableTheming="False" RepeatColumns="1" BorderStyle="None" CellPadding="1" ForeColor="White" GridLines="Horizontal">
                           <ItemTemplate>
                                ...
                                <div class="row" style="margin-top: 235px; text-align: center">
                                    <font size="16px" style="font-family:Edwardian Script ITC; font-weight :bold"><asp:Label ID="lblTeacherName" Style="padding-top: 430px;"  ForeColor="Black" runat="server" Text='<%#Eval("Names") %>'></asp:Label></font>
                                </div>
                                <div class="row  text-center" style="margin-top: 85px; text-align: center">
                                    <b><font size="5"><asp:Label ID="lblRegistrationNumber" runat="server" ForeColor="Black" Text='<%#Eval("registration_nos")%>'></asp:Label></font></b>
                                </div>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="float: left; margin-left: 210px">
                                                    <font size="5"><asp:Label ID="lblDates" runat="server" Text='<%#:DateTime .Now.Day %>'></asp:Label></font>
                                                   <font size="5"> <asp:Label ID="lblDate" runat="server" ForeColor="Black" Text='<%#(DateTime.Now.Day % 10 == 1 && DateTime.Now.Day != 11) ? "st" : (DateTime.Now.Day % 10 == 2 && DateTime.Now.Day != 12) ? "nd" : (DateTime.Now.Day % 10 == 3 && DateTime.Now.Day != 13) ? "rd" : "th" %>'></asp:Label></font>
                                                </td>
                                                <td style="float: right; margin-left: 200px">
                                                    <font size="5" ><asp:Label ID="lblMonthYear" runat="server" ForeColor="Black" Text='<%#:DateTime.Now.ToString("MMMM") + " " + "," + DateTime .Now.Year  %>'></asp:Label></font>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
