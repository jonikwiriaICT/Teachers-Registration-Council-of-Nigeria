<%@ Page Title="" Language="C#" MasterPageFile="~/TrcnMaster.master" AutoEventWireup="true" CodeFile="VerifiedTeachers.aspx.cs" Inherits="HenryAdm_VerifiedTeachers" ValidateRequest ="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="Not-Verified-Teachers">Not Verified Teacher' Records</a>

            </li>
            <li class="breadcrumb-item active">Verified Teacher Record
    ...
    <div class=" card" style="font-size: 11px">
        <div class="card-header">
            <h4 class="card-title"><i class=" la la-pencil "></i>&nbsp Verified Teacher Record</h4>
                ...
                <ul class="list-inline mb-0">
                    ...
                    <li>
                        <div class="dropdown-menu arrow" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
                            ...
                            <asp:LinkButton ID="lnkExportToWord" runat="server" OnClick="verifyBtnClicked" CssClass="dropdown-item"><i class="la la-plus"></i>&nbsp Unverify All Record</asp:LinkButton>
                            <div class="dropdown-divider" id="div" runat="server" visible="true"></div>
                            <asp:LinkButton ID="lnkExportToExcel" runat="server" OnClick="verifyByChecked" CssClass="dropdown-item"><i class=" la la-floppy-o"></i>&nbsp Unverify Checked Rows</asp:LinkButton>
