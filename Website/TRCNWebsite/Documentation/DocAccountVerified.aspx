<%@ Page Title="" Language="C#" MasterPageFile="~/TrcnMaster.master" AutoEventWireup="true" CodeFile="DocAccountVerified.aspx.cs" Inherits="Documentation_DocAccountVerified" ValidateRequest="false" %>
    ...
    <div id="teacherRegistrationInformation" runat="server">
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Not Verifed Record</a>
                    </li>
                    <li class="breadcrumb-item"><a href="#">Teachers' Registration</a>
                    </li>
                    <li class="breadcrumb-item active">Verified Teachers' Log
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class=" card" style="font-size: 11px">
            <div class="card-header">
                <h4 class="card-title"><i class=" la la-pencil-square "></i>&nbsp Verified Teachers' Log</h4>
