<%@ Page Title="" Language="C#" MasterPageFile="~/TrcnMaster.master" AutoEventWireup="true" CodeFile="TeacherRegistration.aspx.cs" Inherits="Documentation_TeacherRegistration" ValidateRequest ="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li>
                            <div class="dropdown-menu arrow" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
                                ...
                                <div class="dropdown-divider" runat="server" visible="true"></div>
                                <asp:LinkButton ID="lnkCheck" Visible="true" runat="server" OnClick="checkAll" CssClass="dropdown-item"><i class=" la la-check"></i>&nbsp Check</asp:LinkButton>
                                <div class="dropdown-divider" runat="server" visible="true"></div>
                                <asp:LinkButton ID="lnkDeleteByRange" Visible="true" runat="server" OnClick="deleteCheckedRows" CssClass="dropdown-item"><i class=" la la-trash"></i>&nbsp Delete checked Rows</asp:LinkButton>
                                <div class="dropdown-divider" runat="server" visible="true"></div>
                                <asp:LinkButton ID="lnkDeleteAll" Visible="true" runat="server" OnClick="deleteAllRecords" CssClass="dropdown-item"><i class=" la la-trash-o"></i>&nbsp Delete All</asp:LinkButton>
                            </div>
                        </li>
            ...
            <div class=" card-body" style="overflow: auto">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <span>
                                <asp:Label ID="lblStateCount" runat="server" Text="" Font-Bold="true"></asp:Label>
                            </span>
                        </div>
                    </div>
                    <div class="card">
                            ...
                            <div class="row" style="overflow: auto" runat="server" id="divContent">
                                ...
                                <asp:GridView ID="gvList" runat="server" Font-Size="10px" AllowPaging="true" PageSize="100" OnPageIndexChanging="ABIACHANGING"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="7%" Visible="true" HeaderText=" Check Row(S) to Delete" HeaderStyle-CssClass=" thead-default" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
    ...
    <div id="TeacherForm" runat="server">
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="document">Documentation</a>
                    </li>
