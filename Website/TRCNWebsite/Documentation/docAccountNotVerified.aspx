<%@ Page Title="" Language="C#" MasterPageFile="~/TrcnMaster.master" AutoEventWireup="true" CodeFile="docAccountNotVerified.aspx.cs" Inherits="Documentation_docAccountNotVerified" ValidateRequest ="false"  %>
    ...
    <div id="teacherRegistrationInformation" runat="server">
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Documentation</a>
                    </li>
                    <li class="breadcrumb-item"><a href="#"> Verifed Record</a>
                    </li>
                    <li class="breadcrumb-item"><a href="#">Teachers' Registration</a>
                    </li>
                    <li class="breadcrumb-item active">Not Verified Teachers' Log
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class=" card" style="font-size: 11px">
            <div class="card-header">
                <h4 class="card-title"><i class=" la la-pencil "></i>&nbsp Not Verified Teachers' Log</h4>
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li>
                            <div class="dropdown-menu arrow" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
                                ...
                                <asp:LinkButton ID="lnkCheck" Visible ="false"  runat="server" OnClick="checkAll" CssClass="dropdown-item"><i class=" la la-check"></i>&nbsp Check</asp:LinkButton>
                                <div class="dropdown-divider" runat ="server" visible ="false" ></div>
                                <asp:LinkButton ID="lnkDeleteByRange" Visible ="false"  runat="server" OnClick="deleteCheckedRows" CssClass="dropdown-item"><i class=" la la-trash"></i>&nbsp Delete checked Rows</asp:LinkButton>
                                <div class="dropdown-divider" runat ="server" visible ="false" ></div>
                                <asp:LinkButton ID="lnkDeleteAll" Visible ="false"  runat="server" OnClick="deleteAllRecords" CssClass="dropdown-item"><i class=" la la-trash-o"></i>&nbsp Delete All</asp:LinkButton>
                            </div>
                        </li>
                            ...
                            <div class="row" style="overflow: auto" runat="server" id="divContent">
                                ...
                                <asp:GridView ID="gvList" runat="server" Font-Size="10px" AllowPaging="true" PageSize="1000" OnPageIndexChanging="ABIACHANGING"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="5%" Visible ="false"  HeaderText="" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="7%" Visible ="false"  HeaderText=" Check Row(S) to Delete"  HeaderStyle-CssClass=" thead-default" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="adminTrcnRegister">Teacher Registration</a>
                    </li>
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li>
                            <div class="dropdown-menu arrow" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
                                ...
                                <asp:LinkButton ID="LinkButton4" runat="server" OnClick="goBacks" CssClass="dropdown-item"><i class=" la la-arrow-circle-left"></i>&nbsp Go Back</asp:LinkButton>
                    ...
                    <div class="container" style="font-size: 10px">
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <asp:LinkButton ID="LinkButton6" Visible="false" OnClick="getLgaByStateofOrigin" CssClass="btn btn-sm btn-primary " runat="server"><i class="fa fa-search text-white "></i>&nbsp Get LGA</asp:LinkButton>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-element-list mg-t-30">
                                    ...
                                    <hr />
                                    <div class="row">
                                        <asp:HiddenField ID="education_level" runat="server" />
                                        <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-element-list mg-t-30">
                                    <div class="cmp-tb-hd">
                                        <h2 class="text-danger ">TRCN REGISTRATION</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <asp:TextBox ID="bank_teller" runat="server" CssClass="form-control " placeholder="RRR Number"></asp:TextBox>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <asp:TextBox ID="amount_paid" runat="server" CssClass="form-control " placeholder="Amount Paid"></asp:TextBox>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <asp:TextBox ID="bank_name" runat="server" CssClass="form-control " placeholder="Bank Name"></asp:TextBox>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <asp:TextBox ID="date_paid" runat="server" CssClass="form-control " placeholder="yyyy/mm/dd"></asp:TextBox>
                                        ...
                                        <div class="col-lg-12" style="overflow: auto">
                                            ...
                                            <asp:GridView ID="gvSchool" runat="server" Font-Size="10px"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="7%" HeaderStyle-CssClass=" thead-default" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="LinkButton8" runat="server" Font-Size="14px"
                                                                CausesValidation="False" CommandName="Delete" CommandArgument='<%# Container.DataItemIndex %>'>
                                                    <i class=" la la-trash-o text-danger" ></i>
                                                            </asp:LinkButton>
                                                        </ItemTemplate>
                    ...
                    <div class="modal-body" style="font-size: 10px">
                        ...
                        <asp:Panel ID="pnlSchool" runat="server">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <asp:TextBox ID="state_location" runat="server" CssClass=" form-control"></asp:TextBox>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <asp:TextBox ID="lga_location" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="col-md-7" runat="server" visible="false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <asp:TextBox ID="when_did_your_teaching_career_start" data-mask="99/99/9999" placeholder="dd/mm/yyyy" runat="server" CssClass="form-control "></asp:TextBox>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <asp:TextBox ID="when_did_you_leave_the_school" data-mask="99/99/9999" placeholder="dd/mm/yyyy" runat="server" CssClass="form-control  "></asp:TextBox>
