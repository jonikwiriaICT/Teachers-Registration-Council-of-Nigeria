<%@ Page Title="" Language="C#" MasterPageFile="~/TrcnMaster.master" AutoEventWireup="true" CodeFile="certPrintedRecords.aspx.cs" Inherits="Certificate_certPrintedRecords" ValidateRequest ="false"  %>
                        ...
                        <asp:DataList ID="dtPrint" Style="width: 100%; border: none" BorderColor="white" runat="server" EnableTheming="False" RepeatColumns="1" BorderStyle="None" CellPadding="1" ForeColor="White" GridLines="Horizontal">
                            <ItemTemplate>
                                ...
                                <div class="row" style="margin-top: 235px; text-align: center">
                                    <b><font size="16px" style="font-family: Edwardian Script ITC; font-weight: bold">
